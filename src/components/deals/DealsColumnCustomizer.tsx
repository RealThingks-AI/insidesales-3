...
interface DealsColumnCustomizerProps {
  columns: DealColumn[];
  onColumnsChange: (columns: DealColumn[]) => void;
}

const DealsColumnCustomizer = ({ columns, onColumnsChange }: DealsColumnCustomizerProps) => {
...
export default DealsColumnCustomizer;